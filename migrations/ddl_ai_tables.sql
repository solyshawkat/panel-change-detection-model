...
--  Comparison identified by: taskcheck_execution_id
...
CREATE TABLE ai_comparisons (
    id                      SERIAL PRIMARY KEY,
    taskcheck_execution_id  INTEGER NOT NULL UNIQUE,
...
-- Indexes
CREATE INDEX idx_ai_comparisons_execution_id ON ai_comparisons (taskcheck_execution_id);
